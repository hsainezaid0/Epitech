...
for language in special_characters:
    for character in special_characters[language]:
...
if detected_language != "":
    ...
    if total == 0:
        ...
        for language in languages:
            ...
            for letter in frequencies:
                ...
                if letter in languages[language]:
                    ...
                    text_percentage = frequencies[letter] / total * 100
                    language_percentage = languages[language][letter]

                    difference = abs(
                        text_percentage - language_percentage
                    )
        ...
        for language in scores:
            ...
            if best_score == None or scores[language] < best_score:
                best_score = scores[language]
                best_language = language

        print("Language:", best_language)text = input("Enter a text: ").lower()
